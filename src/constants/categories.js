...
export const CATEGORIES = {
  fitness: { label: "Fitness", icon: Dumbbell,  color: "#E8B14A", stat: "strength",   attribute: "Strength"   },
  school:  { label: "School",  icon: BookOpen,  color: "#7CA9F2", stat: "intellect",  attribute: "Intellect"  },
  life:    { label: "Life",    icon: Heart,     color: "#E89B8A", stat: "vitality",   attribute: "Vitality"   },
...
export const ARCHETYPES = {
  warrior:  { label: "Warrior",  icon: Swords,    color: "#E8B14A", desc: "Forged in fitness"     },
  scholar:  { label: "Scholar",  icon: BookOpen,  color: "#7CA9F2", desc: "Driven by knowledge"   },
